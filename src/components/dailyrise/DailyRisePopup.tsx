        ...
        >
          ...
          >
            ...
            <div className="px-6 py-5 border-t border-white/10 flex gap-3">
              <Button
                onClick={onClose}
                className="flex-1 rounded-2xl font-display font-bold text-white shadow-lg"
                style={{ background: "linear-gradient(135deg, #2E8B57, #0F5132)" }}
              >
                Start My Day
              </Button>
              <Button
                ...
                variant="ghost"
                className="flex-1 rounded-2xl font-display font-medium text-white/70 hover:text-white border border-white/15 hover:bg-white/10"
              >
